...
from speakerembedder import get_deep_speaker_emb
# from pypinyin import pinyin, Style

from utils.model import get_model, get_vocoder
from utils.tools import get_configs_of, to_device, synth_samples
from dataset import Dataset, TextDatasetOneshotLJ
...
class CMTotalTTSSynthesize:
    ...
    def synthesize(self, batch):
        ...
        print(batch[0][0])
        spker_embeds = get_deep_speaker_emb(
                filepath=f"./raw_data/LJSpeech/LJSpeech/{batch[0][0]}.wav",
...
if __name__ == "__main__":
    ...
    if args.cut:
        train_config["path"]["result_path"] = train_config["path"]["result_path"]+"cut"
    ...
    if args.mode == "batch":
        ...
        if args.teacher_forced:
            ...
            dataset = TextDatasetOneshotLJ(args.source, preprocess_config, model_config)
        batchs = DataLoader(
            dataset,
            batch_size=1,
